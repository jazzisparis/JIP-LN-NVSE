...
__declspec(naked) __m128 __vectorcall NiMatrix33::ToEulerYPR() const
{
	__asm
	{
		movups	xmm0, [ecx+4]
...
{
	rotate.Dump();
	NiVector4 angles = _mm_mul_ps(rotate.ToEulerPRY(), GET_PS(9));
